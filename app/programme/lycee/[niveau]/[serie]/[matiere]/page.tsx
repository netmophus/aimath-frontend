 ...
 *
 * Données STATIQUES (lib/programmeLyceeStatique.ts) — tout est
 * PROGRAMME_PLACEHOLDER pour l'instant (contrairement au collège, déjà
 * rempli) : le vrai contenu sera intégré niveau/série par niveau/série dans
 * un second temps.
 */
